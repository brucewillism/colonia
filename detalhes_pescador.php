        ...
        <div class="col-sm-6 col-md-4">
          ...
          <div class="thumbnail">
            ...
            <div class="caption">
              ...
              $stmt = $pdo->query('SELECT * FROM Pescadores WHERE id = $id');

              ?>
              <div class="w3-container">
                <?php while ($cadastro = $stmt->fetchObject()): ?>
...
<div class="w3-twothird" >
  ...
  <div class="w3-container w3-card w3-white w3-margin-bottom">
    <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Detalhes Empresa</h2>
