...
$sql ="INSERT INTO pescadores_caicaras (id, matricula, nome, endereco, bairro, estado, cpf, nascimento, rgp, nome_pai, nome_mae, dependente, data_ins, insc_inss, rg, estado_civil, assinatura_socio, assinatura_presidente)
VALUES (:id, :matricula, :nome, :endereco, :bairro, :estado, :cpf, :nascimento,:rgp,:nome_pai,:nome_mae,:dependente,:data_ins,:insc_inss,:rg,:estado_civil,:assinatura_socio, :assinatura_presidente)";
