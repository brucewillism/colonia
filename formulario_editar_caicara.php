...
$stmt = $conn->prepare = "SELECT id,  matricula, nome, endereco, bairro, estado, cpf, nascimento, rgp, nome_pai, nome_mae, dependente, data_ins, insc_inss, rg, estado_civil, assinatura_socio, assinatura_presidente FROM pescadores_caicaras WHERE id='$id'";
...
<body>
    <h1>Editar</h1>
    <form action="editar2.php?id=<?php echo $id; ?>" method="POST">
