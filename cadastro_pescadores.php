...
<body>
  <form action="bd/cadastrar_pescadores.php" method="POST">
   <div class="ola">  
     ...
     <label>Titulo</label>
     <input type="text" id="telefone"  name="titulo" placeholder="Digite Seu Titulo">
    ...
    <input type="date" name="nascimento" placeholder="Digite Sua Data de nascimento"required></br>
    <label>Órgão Exp</label>
    <input type="text" name="orgao" placeholder="Digite seu Órgão Expedidor"required></br>
    <label>RGP</label>
    <input type="number" name="rgp" placeholder="Digite Seu RGP"required>
    <label>Data Da Inscrição</label>
    <input type="date" name="data_ins" placeholder="Digite a Data derequired Inscricão"required></br>
    ...
    <input type="number" name="rg" placeholder="Digite Seu RG"required>
